...
export default function AllAboutMeForm({ onSubmit }) {
                ...
                <div className='col-md-6'>
                  <div className='form-group'>
                    ...
                    <input
                      ...
                      name='food'
                      onChange={(e) =>
                        handleInputChange('food', e.target.value)
                      }
                ...
                <div className='col-md-6'>
                  <div className='form-group'>
                    ...
                    <input
                      ...
                      name='animal'
                      onChange={(e) =>
                        handleInputChange('animal', e.target.value)
                      }
                      placeholder='Type here...'
                    />
                  </div>
          ...
          <div className='about-progression-form'>
            <div className='about-me-form'>
                ...
                <div className=''>
                  <div className='form-group long-input'>
                    <input
                      ...
                      name='like1'
                      onChange={(e) =>
                        handleInputChange('like1', e.target.value)
                      }
                      placeholder='Type here...'
                    />
                  </div>
                ...
                <div className=''>
                  <div className='form-group long-input'>
                    <input
                      ...
                      name='like2'
                      onChange={(e) =>
                        handleInputChange('like2', e.target.value)
                      }
                      placeholder='Type here...'
                    />
                  </div>
              ...
              <div className='d-flex align-items-center justify-content-around mx-auto'>
                <button
                  className='btn about-me-form-btn btn-back mx-2'
                ...
                <div className='col-md-6'>
                  <div className='form-group radio-input'>
                    <input
                      type='checkbox'
                      name='nicePerson'
                      id='nice-person-checkbox'
                      checked={formData.nicePerson}
                      onChange={(e) =>
                        handleInputChange('nicePerson', e.target.checked)
                      }
                    />
                ...
                <div className='col-md-6'>
                  <div className='form-group radio-input'>
                    <input
                      type='checkbox'
                      name='funnyPerson'
                      id='funny-person-checkbox'
                      checked={formData.funnyPerson}
                      onChange={(e) =>
                        handleInputChange('funnyPerson', e.target.checked)
                      }
                    />
                ...
                <div className='col-md-6'>
                  <div className='form-group radio-input'>
                    <input
                      type='checkbox'
                      name='goodReading'
                      id='good-reading-checkbox'
                      checked={formData.goodReading}
                      onChange={(e) =>
                        handleInputChange('goodReading', e.target.checked)
                      }
                    />
                ...
                <div className='col-md-6'>
                  <div className='form-group radio-input'>
                    <input
                      type='checkbox'
                      name='goodMath'
                      id='good-math-checkbox'
                      checked={formData.goodMath}
                      onChange={(e) =>
                        handleInputChange('goodMath', e.target.checked)
                      }
                    />
                ...
                <div className='col-md-6'>
                  <div className='form-group radio-input'>
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange('sporty', e.target.checked)
                      }
                    />
                ...
                <div className='col-md-6'>
                  <div className='form-group radio-input'>
                    <input
                      type='checkbox'
                      name='helpingOthers'
                      id='helping-others-checkbox'
                      checked={formData.helpingOthers}
                      onChange={(e) =>
                        handleInputChange('helpingOthers', e.target.checked)
                      }
                    />
                ...
                <div className='col-md-6'>
                  <div className='form-group radio-input'>
                    <input
                      type='checkbox'
                      name='calmPerson'
                      id='calm-person-checkbox'
                      checked={formData.calmPerson}
                      onChange={(e) =>
                        handleInputChange('calmPerson', e.target.checked)
                      }
                    />
                ...
                <div className=''>
                  <div className='form-group long-input'>
                    <input
                      ...
                      name='funFact1'
                      onChange={(e) =>
                        handleInputChange('funFact1', e.target.value)
                      }
                      placeholder='Type here...'
                    />
                  </div>
                ...
                <div className=''>
                  <div className='form-group long-input'>
                    <input
                      ...
                      name='funFact2'
                      onChange={(e) =>
                        handleInputChange('funFact2', e.target.value)
                      }
                      placeholder='Type here...'
                    />
                  </div>
                ...
                <div className=''>
                  <div className='form-group long-input'>
                    <input
                      ...
                      name='favouriteColor'
                      onChange={(e) =>
                        handleInputChange('favouriteColor', e.target.value)
                      }
                      placeholder='Type here...'
                    />
                  </div>
                ...
                <div className=''>
                  <div className='form-group long-input'>
                    <input
                      ...
                      name='bestFriendName'
                      onChange={(e) =>
                        handleInputChange('bestFriendName', e.target.value)
                      }
                      placeholder='Type here...'
                    />
                  </div>
                ...
                <div className=''>
                  <div className='form-group long-input'>
                    <input
                      ...
                      name='favoriteHobby'
                      onChange={(e) =>
                        handleInputChange('favoriteHobby', e.target.value)
                      }
                      placeholder='Type here...'
                    />
                  </div>
  ...
  return (
    <div className='all-aboutme-progression-page'>{renderFormContent()}</div>
  )
}
